...
namespace GameEntry.JsonScopeDataTest.Abilities.MovementAbilities;
...
{
    #region 技能定义
    public static readonly GameLink<GameDataAbility, GameDataAbilityExecute> Roll = new("JsonTestRoll"u8);
    #endregion

    #region 效果定义
    public static readonly GameLink<GameDataEffect, GameDataEffectUnitMoverApply> RollMoverApply = new("JsonTestRollMoverApply"u8);
    public static readonly GameLink<GameDataEffect, GameDataEffectBuffAdd> RollInvulnerabilityApply = new("JsonTestRollInvulnerabilityApply"u8);
    public static readonly GameLink<GameDataEffect, GameDataEffectSet> RollEffectSet = new("JsonTestRollEffectSet"u8);
    #endregion

    #region Mover定义
    public static readonly GameLink<GameDataMover, GameDataMoverTarget> RollMover = new("JsonTestRollMover"u8);
    #endregion

    #region Buff定义
    public static readonly GameLink<GameDataBuff, GameDataBuff> RollInvulnerabilityBuff = new("JsonTestRollInvulnerabilityBuff"u8);
    #endregion

    #region 冷却定义
    public static readonly GameLink<GameDataCooldown, GameDataCooldownActive> RollCooldown = new("JsonTestRollCooldown"u8);
    #endregion

    #region 动画定义
    public static readonly GameLink<GameDataAnimation, GameDataAnimationSimple> RollAnim = new("JsonTestRollAnim"u8);
    #endregion

    #region 粒子和Actor定义
    public static readonly GameLink<GameDataParticle, GameDataParticle> RollTrailParticle = new("JsonTestRollTrailParticle"u8);
    public static readonly GameLink<GameDataActor, GameDataActorParticle> RollTrailEffect = new("JsonTestRollTrailEffect"u8);
    #endregion
    ...
    {
        Game.Logger.LogInformation("🤸‍♂️ Initializing Roll Ability for JsonScopeDataTest...");
        ...
        _ = new GameDataAbilityExecute(Roll)
        {
            ...
            TargetType = AbilityTargetType.Ground, // 使用Ground而不是Vector
